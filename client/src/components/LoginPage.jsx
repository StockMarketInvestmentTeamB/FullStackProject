 ...
 const LoginPage = () => {
    ...
    //          console.log("Logged in user:", userData);  // check if name appears here
    //          localStorage.setItem('user', JSON.stringify(userData));  // Save entire user
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          ...
          // If API returns a token, store it; otherwise, rely on "user" only
          if (userData.token) {
